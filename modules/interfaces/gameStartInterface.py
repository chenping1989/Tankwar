...
def gameStartInterface(screen, cfg):
    ...
    tank_cursor = pygame.image.load(cfg.PLAYER_TANK_IMAGE_PATHS.get('player1')[0]).convert_alpha().subsurface((0, 144),
                                                                                                              (48, 48))
    ...
    game_tip_rect.centerx, game_tip_rect.centery = cfg.WIDTH / 2, cfg.HEIGHT / 1.4
